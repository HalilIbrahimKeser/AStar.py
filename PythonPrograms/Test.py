...
class Kalman():
    ...
    def MeasurementUncertainty(self):
        ...
        measurementUncertainty = (self._Pn_n + ((self._delta_t * self._delta_t) * self._Pn_n)) / self._n
    ...
    def calc_next(self, z_i):
        ...
        self._xn_n = self._xn_n + self._Pn_n


        # self._Pn_n = self.MeasurementUncertainty()
        print("\ntarget.rect.x: \t\t", target.rect.x)
        print("self._xn_n: ", self._xn_n)
        # print("self._z_n: ", self._z_n)
        # print("self._xdotn_n: ", self._xdotn_n)
        print("measurementUncertainty", self._Pn_n)
